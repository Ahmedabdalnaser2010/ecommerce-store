...
const DoneOrderPage = () => {
    return (
        ...
        <div className="flex flex-col items-center justify-evenly h-[320px] mx-auto text-blue-400">
            ...
            <Link to="/">
                <button aria-label='go to homepage' className="h-[40px] bg-blue-400 hover:bg-blue-500 rounded-md text-sm text-white w-full block font-medium px-4 transition mt-4">Back To Home</button>
            </Link>
        </div>
    )
}
